...
on(libPrefix + 'res', res); 
on(libPrefix + 'getResult', getResult); 
on(libPrefix + 'transfer', trasfer); 
on(libPrefix + 'balance', balance); 
on(libPrefix + 'getResponse', getResponse); 
 
publish({ 
 checkKeys:checkKeys, 
 checkBashkey:checkBashkey, 
 getPrice:getPrice, 
